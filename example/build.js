	...
	module.exports = React.createClass({displayName: 'exports',
	  ...
	  render: function() {
	    ...
	    var tags = this.state.tags.map(function(tag,i) {
	      return (
	        React.DOM.div( {className:"taginput_tag", key:i, onClick:this.killTag.bind(null, i)}, 
	           tag, 
	          React.DOM.span( {className:"taginput_x"}, 
	            "X"
	          )
	        )
	      );
	    ...
	    return this.transferPropsTo(
	      React.DOM.div( {className:"taginput_container", ref:"container", onClick:this.onClick, style:{ height: this.state.height ? this.state.height + 'px' : 'auto' }}, 
	        React.DOM.input( {autofocus:true, ref:"input", type:"text", value:this.state.tagval, onKeyDown:this.onEnter, onChange:this.handleChange, style:{ left: this.state.offset + 'px', width: this.state.width - this.state.offset - 2 }} ),
	        React.DOM.div( {className:"taginput_tags", ref:"tags"}, 
	           tags 
	        )
	      )
	    );
...
/***/ function(module, exports, require) {
	...
	var DOMPropertyOperations = require(9);
	var EventPluginUtils = require(10);
	...
	var ReactDOM = require(16);
	var ReactDOMComponent = require(17);
	var ReactDefaultInjection = require(18);
	var ReactInstanceHandles = require(19);
	var ReactMount = require(20);
	var ReactMultiChild = require(21);
	var ReactPerf = require(22);
	var ReactPropTypes = require(23);
	var ReactServerRendering = require(24);
	var ReactTextComponent = require(25);

	var onlyChild = require(26);
	...
	/* WEBPACK VAR INJECTION */}.call(exports, require, require(93)))
...
/***/ function(module, exports, require) {
	...
	var LinkedStateMixin = require(28);
	var React = require(4);
	var ReactCSSTransitionGroup = require(29);
	var ReactTransitionGroup = require(30);
	var ReactCSSTransitionGroup = require(29);

	var cx = require(31);
	var cloneWithProps = require(32);
	var update = require(33);
	...
	if ("production" !== process.env.NODE_ENV) {
	  React.addons.TestUtils = require(34);
	}
...
/***/ function(module, exports, require) {
	...
	var PooledClass = require(41);

	var invariant = require(40);
	var traverseAllChildren = require(42);
...
/***/ function(module, exports, require) {
	...
	var ReactCurrentOwner = require(15);
	var ReactOwner = require(43);
	var ReactUpdates = require(44);

	var invariant = require(40);
	var keyMirror = require(45);
	var merge = require(46);
	var monitorCodeUse = require(47);
...
/***/ function(module, exports, require) {
	...
	var ReactContext = require(14);
	var ReactCurrentOwner = require(15);
	var ReactErrorUtils = require(48);
	var ReactOwner = require(43);
	var ReactPerf = require(22);
	var ReactPropTransferer = require(49);
	var ReactPropTypeLocations = require(50);
	var ReactPropTypeLocationNames = require(51);
	var ReactUpdates = require(44);

	var instantiateReactComponent = require(52);
	var invariant = require(40);
	var keyMirror = require(45);
	var merge = require(46);
	var mixInto = require(53);
	var monitorCodeUse = require(47);
	var objMap = require(54);
	var shouldUpdateReactComponent = require(55);
	var warning = require(38);
...
/***/ function(module, exports, require) {
	...
	var mergeInto = require(56);
	var objMapKeyVal = require(57);
...
/***/ function(module, exports, require) {
	...
	var CSSPropertyOperations = require(58);
	var DOMProperty = require(35);
	var DOMPropertyOperations = require(9);
	var ReactBrowserComponentMixin = require(59);
	var ReactComponent = require(12);
	var ReactEventEmitter = require(60);
	var ReactMount = require(20);
	var ReactMultiChild = require(21);
	var ReactPerf = require(22);
...
/***/ function(module, exports, require) {
	...
	var DefaultDOMPropertyConfig = require(64);

	var ChangeEventPlugin = require(65);
	var ClientReactRootIndex = require(66);
	var CompositionEventPlugin = require(67);
	var DefaultEventPluginOrder = require(68);
	var EnterLeaveEventPlugin = require(69);
	var MobileSafariClickEventPlugin = require(70);
	var ReactBrowserComponentMixin = require(59);
	var ReactComponentBrowserEnvironment =
	  require(71);
	var ReactEventTopLevelCallback = require(72);
	var ReactDOM = require(16);
	var ReactDOMButton = require(73);
	var ReactDOMForm = require(74);
	var ReactDOMImg = require(75);
	var ReactDOMInput = require(76);
	var ReactDOMOption = require(77);
	var ReactDOMSelect = require(78);
	var ReactDOMTextarea = require(79);
	var ReactInstanceHandles = require(19);
	var ReactMount = require(20);
	var SelectEventPlugin = require(80);
	var ServerReactRootIndex = require(81);
	var SimpleEventPlugin = require(82);

	var ReactDefaultBatchingStrategy = require(83);

	var createFullPageComponent = require(84);
	...
	function inject() {
	  ...
	  if ("production" !== process.env.NODE_ENV) {
	    ...
	    if ((/[?&]react_perf\b/).test(url)) {
	      var ReactDefaultPerf = require(85);
...
/***/ function(module, exports, require) {
	...
	var ReactComponent = require(12);
	var ReactMultiChildUpdateTypes = require(88);

	var flattenChildren = require(89);
	var instantiateReactComponent = require(52);
	var shouldUpdateReactComponent = require(55);
...
/***/ function(module, exports, require) {
	...
	var warning = require(38);
	var createObjectFrom = require(90);
...
/***/ function(module, exports, require) {
	...
	var ReactLink = require(94);
	var ReactStateSetters = require(95);
...
/***/ function(module, exports, require) {
	...
	var ReactTransitionGroup = require(30);
	var ReactCSSTransitionGroupChild = require(102);
...
/***/ function(module, exports, require) {
	...
	var React = require(4);
	var ReactTransitionChildMapping = require(96);

	var cloneWithProps = require(32);
	var emptyFunction = require(97);
	var merge = require(46);
...
/***/ function(module, exports, require) {
	...
	var CSSProperty = require(106);

	var dangerousStyleValue = require(107);
	var escapeTextForBrowser = require(36);
	var hyphenate = require(108);
	var memoizeStringOnly = require(37);
...
/***/ function(module, exports, require) {
	...
	var ExecutionEnvironment = require(27);
	var ReactEventEmitterMixin = require(111);
	var ViewportMetrics = require(112);

	var invariant = require(40);
	var isEventSupported = require(113);
	var merge = require(46);
...
/***/ function(module, exports, require) {
	...
	var isEventSupported = require(113);
	var isTextInputElement = require(114);
	var keyOf = require(61);
...
/***/ function(module, exports, require) {
	...
	var EventPropagators = require(100);
	var ExecutionEnvironment = require(27);
	var ReactInputSelection = require(115);
	var SyntheticCompositionEvent = require(116);

	var getTextContentAccessor = require(117);
	var keyOf = require(61);
...
/***/ function(module, exports, require) {
	...
	var ReactDOMIDOperations = require(118);
	var ReactMarkupChecksum = require(91);
	var ReactMount = require(20);
	var ReactPerf = require(22);
	var ReactReconcileTransaction = require(119);
...
/***/ function(module, exports, require) {
	...
	var getEventTarget = require(121);
	var mixInto = require(53);
...
/***/ function(module, exports, require) {
	...
	var EventPluginUtils = require(10);
	var EventPropagators = require(100);
	var SyntheticClipboardEvent = require(126);
	var SyntheticEvent = require(101);
	var SyntheticFocusEvent = require(127);
	var SyntheticKeyboardEvent = require(128);
	var SyntheticMouseEvent = require(120);
	var SyntheticDragEvent = require(129);
	var SyntheticTouchEvent = require(130);
	var SyntheticUIEvent = require(131);
	var SyntheticWheelEvent = require(132);
...
/***/ function(module, exports, require) {
	...
	var DOMProperty = require(35);
	var ReactDefaultPerfAnalysis = require(135);
	var ReactMount = require(20);
	var ReactPerf = require(22);

	var performanceNow = require(136);
...
/***/ function(module, exports, require) {
	...
	var PooledClass = require(41);
	var ReactMountReady = require(138);
	var ReactPutListenerQueue = require(139);
	var Transaction = require(133);
...
/***/ function(module, exports, require) {
	...
	exports.binding = function (name) {
	    if (name === 'evals') return (require)(146)
...
/***/ function(module, exports, require) {
	...
	var CSSCore = require(144);
	var ReactTransitionEvents = require(145);
...
/***/ function(module, exports, require) {
	...
	var ReactDOMSelection = require(148);

	var containsNode = require(86);
	var focusNode = require(149);
	var getActiveElement = require(124);
...
/***/ function(module, exports, require) {
	...
	var CSSPropertyOperations = require(58);
	var DOMChildrenOperations = require(150);
	var DOMPropertyOperations = require(9);
	var ReactMount = require(20);
	var ReactPerf = require(22);
...
/***/ function(module, exports, require) {
	...
	var createArrayFrom = require(160);
	var getMarkupWrap = require(159);
	var invariant = require(40);
